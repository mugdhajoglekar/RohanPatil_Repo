...
select FIRST_NAME, LAST_NAME from employees where FIRST_NAME like 'S%' or FIRST_NAME like '_S';
...
select FIRST_NAME, LAST_NAME from employees where JOB_ID='IT_PROG' or JOB_ID='FI_ACCOUNT';
